...
import com.hibernate.model.Stuff;
...
public class StuffDAO extends BaseHibernateDAO {
	...
	// property constants
	public static final String STUFF_TITLE = "stuffTitle";
	...
	public Stuff findById(java.lang.String id) {
		log.debug("getting Stuff instance with id: " + id);
		try {
			Stuff instance = (Stuff) getSession()
					.get("com.hibernate.Stuff", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Stuff instance) {
		...
		try {
			List results = getSession().createCriteria("com.hibernate.Stuff")
	...
	public List findByStuffTitle(Object stuffTitle) {
		return findByProperty(STUFF_TITLE, stuffTitle);
	}
